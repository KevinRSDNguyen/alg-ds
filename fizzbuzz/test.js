...
test("fizzbuzz(30) prints out 30 console logs", () => {
  fizzBuzz(30);

  expect(console.log.mock.calls.length).toEqual(30);
});

test("fizzbuzz(30) console logs correct values", () => {
  fizzBuzz(30);
  ...
  expect(console.log.mock.calls[29][0]).toEqual("fizzbuzz");
});
